...
df = pd.read_csv("Data/92-appart-with-distance.csv", sep=";")

print(df)

df_test = df[df["centre_ville_distance"].isnull()]

print(df_test)

# df_test=df[df["nom_commune"]=="Clichy"]
...
df.to_csv("Data/92-appart-encoded.csv", sep=";", index=False)