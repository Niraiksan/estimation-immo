...
###################################################################
###################################################################
df_biens = pd.read_csv("Data/92700-appart-type-appart.csv", sep=";")
...
df_biens['centre_ville_distance'] = df_biens.progress_apply(
    lambda row: centre_ville_distance(row['latitude'], row['longitude'], df_poi_colombes, "Colombes"), axis=1
    # lambda row: centre_ville_distance(row['latitude'], row['longitude'], df_poi_colombes, row['nom_commune']), axis=1
)
...
df.to_csv('Data/92700-appart-with-distance.csv', sep=";", index=False, encoding='utf-8')
