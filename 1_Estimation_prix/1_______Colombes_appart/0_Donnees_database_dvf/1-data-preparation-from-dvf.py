...
print("nb données - appart à colombes : ",df.shape)
...
print("nb données - APRES Selection varibles : ",df.shape)
...
plt.savefig("colombes_lots_surface_logement_avantTraitementAberrant.png", dpi=300)
plt.show()
...
sns.boxplot(y=df["lots_surface_logement"])
plt.savefig("colombes_lots_surface_logement_apresTraitementAberrant.png", dpi=300)
plt.show()
...
plt.savefig("colombes_prix_m2_avantTraitementAberrant.png", dpi=300)
plt.show()
...
sns.boxplot(y=df["prix_m2"])
plt.savefig("colombes_prix_m2_apresTraitementAberrant.png", dpi=300)
plt.show()
...
plt.savefig("colombes_valeur_fonciere_avantTraitementAberrant.png", dpi=300)
plt.show()
...
sns.boxplot(y=df["valeur_fonciere"])
plt.savefig("colombes_valeur_fonciere_apresTraitementAberrant.png", dpi=300)
plt.show()
...
print("nb données - APRES TOUS LES TRAITEMENTS ABERRANTS : ")
print(df.shape)
...
#     c=df_selected['lots_surface_logement'], cmap='viridis', s=20
# )
...
cols = [
    'valeur_fonciere', 
    'longitude', 'latitude', 'code_secteur_ville', 'id_parcelle', 'adresse_code_voie',
    'lots_surface_logement', 'nombre_pieces_principales',
    'construction_recente']


# df[cols].to_csv('Data/92700-appart.csv', sep=";", index=False, encoding='utf-8')
...
# y = df_selected['valeur_fonciere']
# X = df_selected.drop('valeur_fonciere', axis=1)
