...
print("nb données - appart à hds : ",df.shape)
...
plt.savefig("92_lots_surface_logement_avantTraitementAberrant.png", dpi=300)
plt.show()
...
sns.boxplot(y=df["lots_surface_logement"])
plt.savefig("92_lots_surface_logement_apresTraitementAberrant.png", dpi=300)
plt.show()
...
plt.savefig("92_prix_m2_avantTraitementAberrant.png", dpi=300)
plt.show()
...
sns.boxplot(y=df["prix_m2"])
plt.savefig("92_prix_m2_apresTraitementAberrant.png", dpi=300)
plt.show()
...
plt.savefig("92_valeur_fonciere_avantTraitementAberrant.png", dpi=300)
plt.show()
...
sns.boxplot(y=df["valeur_fonciere"])
plt.savefig("92_valeur_fonciere_apresTraitementAberrant.png", dpi=300)
plt.show()
...
# df[cols].to_csv('Data/92-appart.csv', sep=";", index=False, encoding='utf-8')
